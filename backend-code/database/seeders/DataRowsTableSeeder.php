    ...
    public function run()
    {
        ...
        \DB::table('data_rows')->insert(array (
            ...
            array (
                'id' => 72,
                'data_type_id' => 9,
                'field' => 'challenge_document',
                'type' => 'text',
                'display_name' => 'Challenge Document',
                'required' => 0,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
            ...
            array (
                'id' => 73,
                'data_type_id' => 9,
                'field' => 'challenge_type_id',
                'type' => 'text',
                'display_name' => 'Challenge Type Id',
                'required' => 0,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
            ...
            array (
                'id' => 75,
                'data_type_id' => 9,
                'field' => 'challenge_belongsto_document_type_relationship',
                'type' => 'relationship',
                'display_name' => 'document_types',
                'required' => 0,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
                'add' => 1,
                'delete' => 1,
                'details' => '{"model":"App\\\\Models\\\\DocumentType","table":"document_types","type":"belongsTo","column":"document_type_id","key":"id","label":"typename","pivot_table":"assigned_challenges","pivot":"0","taggable":"0"}',
                'order' => 8,
            ),
            75 => 
            array (
                'id' => 76,
                'data_type_id' => 9,
                'field' => 'challenge_belongsto_challenge_type_relationship',
                'type' => 'relationship',
                'display_name' => 'challenge_types',
                'required' => 0,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
                'add' => 1,
                'delete' => 1,
                'details' => '{"model":"App\\\\Models\\\\ChallengeType","table":"challenge_types","type":"belongsTo","column":"challenge_type_id","key":"id","label":"typename","pivot_table":"assigned_challenges","pivot":"0","taggable":"0"}',
                'order' => 9,
            ),
            76 => 
            array (
            ...
            array (
                'id' => 100,
                'data_type_id' => 16,
                'field' => 'task_belongsto_competence_relationship',
                'type' => 'relationship',
                'display_name' => 'competences',
                'required' => 0,
                'browse' => 1,
                'read' => 1,
                'edit' => 1,
                'add' => 1,
                'delete' => 1,
                'details' => '{"model":"App\\\\Models\\\\Competence","table":"competences","type":"belongsTo","column":"competence_id","key":"id","label":"competencename","pivot_table":"assigned_challenges","pivot":"0","taggable":"0"}',
                'order' => 10,
            ),
            100 => 
            array (
            ...
            array (
                'id' => 105,
                'data_type_id' => 1,
                'field' => 'user_belongstomany_team_relationship',
                'type' => 'relationship',
                'display_name' => 'teams',
                'required' => 0,
                'browse' => 1,
                ...
                'add' => 1,
                'delete' => 1,
                'details' => '{"model":"App\\\\Models\\\\Team","table":"teams","type":"belongsToMany","column":"id","key":"id","label":"teamname","pivot_table":"team_users","pivot":"1","taggable":"on"}',
                'order' => 13,
            ),
            105 => 
            array (
